...
if __name__ == "__main__":
    image = cv2.imread("/home/jibokai/affordance/LISA/affordance_dataset/rgb/1e3d01f7-e453-4208-b222-278545637aec_00014.jpg")
    ...
    sam.to(device)
    im, anns = inference_sam_m2m_auto(sam, Image.fromarray(image), 8, label_mode='1', alpha=0.1, anno_mode=['Mask'])
    print(anns)
    plt.imshow(im); plt.axis('off'); plt.savefig('test.png')